...
def upgrade():
    ...
    op.create_table('deliverables',
                    ...
                    sa.PrimaryKeyConstraint('id'))
    op.create_table('emails', sa.Column(
    ...
    op.create_table('report_types',
                    ...
                    sa.PrimaryKeyConstraint('id'))
    op.create_table('roles', sa.Column(
        'created', sa.DateTime(), nullable=True),
                    sa.Column('updated', sa.DateTime(), nullable=True),
                    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f('ix_roles_default'), 'roles', ['default'], unique=False)
    op.create_table('tags', sa.Column('created', sa.DateTime(), nullable=True),
                    sa.Column('updated', sa.DateTime(), nullable=True),
                    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_table('tasks_groupmeta',
                    ...
                    sa.Column('id', sa.Integer(), nullable=False),
                    sa.Column(
                        'taskset_id', sa.String(length=255), nullable=True),
    ...
    op.create_table(
        'organizations', sa.Column('created', sa.DateTime(), nullable=True),
        sa.Column('updated', sa.DateTime(), nullable=True),
        sa.Column('id', sa.Integer(), nullable=False),
        ...
        sa.Column('deleted', sa.Integer(), nullable=True),
        sa.ForeignKeyConstraint(
            ['organization_group_id'], ['organization_groups.id'],
            name='fk_org_group_id'), sa.PrimaryKeyConstraint('id'))
    op.create_index(
    ...
    op.create_table('asn', sa.Column('created', sa.DateTime(), nullable=True),
                    sa.Column('updated', sa.DateTime(), nullable=True),
                    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_table('contactemails_organizations',
                    ...
                    sa.PrimaryKeyConstraint('id', 'email_id',
                                            'organization_id'))
    op.create_table('contacts',
                    ...
                    sa.Column('name', sa.String(length=255), nullable=False),
                    sa.Column(
                        'position', sa.String(length=255), nullable=False),
    ...
    op.create_table('fqdns', sa.Column(
        'created', sa.DateTime(), nullable=True),
                    sa.Column('updated', sa.DateTime(), nullable=True),
                    sa.Column('id', sa.Integer(), nullable=False),
                    sa.Column('organization_id', sa.Integer(), nullable=True),
    ...
    op.create_table('ip_ranges',
                    ...
                    sa.Column('organization_id', sa.Integer(), nullable=True),
                    sa.Column(
                        'ip_range', sa.String(length=255), nullable=True),
                    sa.Column('deleted', sa.Integer(), nullable=True),
                    sa.ForeignKeyConstraint(
                        ['organization_id'],
                        ['organizations.id'],
    ...
    op.create_table(
        'users', sa.Column('created', sa.DateTime(), nullable=True),
        sa.Column('updated', sa.DateTime(), nullable=True),
        sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_table('ah_runtime_config_params',
                    ...
                    sa.Column('id', sa.Integer(), nullable=False),
                    sa.Column(
                        'ah_runtime_config_id', sa.Integer(), nullable=True),
                    sa.Column('key', sa.String(length=100), nullable=False),
                    sa.Column('value', sa.String(length=100), nullable=False),
                    sa.ForeignKeyConstraint(
                        ['ah_runtime_config_id'],
    ...
    op.create_table('ah_startup_config_params',
                    ...
                    sa.Column('id', sa.Integer(), nullable=False),
                    sa.Column(
                        'ah_startup_config_id', sa.Integer(), nullable=True),
                    sa.Column('key', sa.String(length=100), nullable=False),
                    sa.Column('value', sa.String(length=100), nullable=False),
                    sa.ForeignKeyConstraint(
                        ['ah_startup_config_id'],
    ...
    op.create_table('samples',
                    ...
                    sa.ForeignKeyConstraint(
                        ['user_id'], ['users.id'], name='fk_sample_user_id'),
                    sa.PrimaryKeyConstraint('id'))
    op.create_table(
        'vulnerabilities', sa.Column('created', sa.DateTime(), nullable=True),
        sa.Column('updated', sa.DateTime(), nullable=True),
        sa.Column('id', sa.Integer(), nullable=False),
        sa.Column('user_id', sa.Integer(), nullable=True),
        sa.Column('organization_id', sa.Integer(), nullable=True),
        ...
        sa.Column(
            'request_method',
            sa.Enum('GET', 'POST', 'PUT', name='httpverb'),
            nullable=True), sa.Column(
                'request_data', sa.Text(), nullable=True),
...
def downgrade():
    ...
    op.drop_index(
        op.f('ix_organizations_abbreviation'), table_name='organizations')
