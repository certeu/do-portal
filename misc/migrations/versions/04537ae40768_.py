...
def upgrade():
    ...
    op.create_table('membership_roles',
                    ...
                    sa.Column(
                        'display_name', sa.String(length=255), nullable=False),
...
def downgrade():
    ...
    op.create_table('organizations_users',
                    ...
                    sa.Column(
                        ...
                        nullable=True),
                    sa.ForeignKeyConstraint(
                        ['org_user_role_id'], ['organization_user_roles.id'],
                        name='organizations_users_org_user_role_id_fkey'),
                    sa.ForeignKeyConstraint(
                        ['organization_id'], ['organizations.id'],
                        name='organizations_users_organization_id_fkey'),
                    sa.ForeignKeyConstraint(
                        ['user_id'], ['users.id'],
                        name='organizations_users_user_id_fkey'),
                    sa.PrimaryKeyConstraint(
                        'id', name='organizations_users_pkey'))
    op.create_table('organization_user_roles',
                    ...
                    sa.Column(
                        ...
                        nullable=False),
                    sa.PrimaryKeyConstraint(
                        'id', name='organization_user_roles_pkey'))
